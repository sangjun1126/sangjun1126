...
<h2>안녕하세요 프론트엔드 개발자 정상준입니다 :)</h2>

<h3>저는 성장하기 위해서</h3>

* 24년 1월 3일에 풀스택 국비지원 교육과정을 수료했어요.
* 제가 공부한 내용을 매일 깃허브에 공유하고 있어요.
* 이론 지식들을 매일 블로그에 업로드해요.
* 실생활에 접할 수 있는 간단한 미니 프로젝트를 자바스크립트로 구현하고 있어요.
* 현재 공부인증 코딩 스터디를 운영하고 있어요.

<h3>저의 성향은요!</h3>

* 토목공학을 졸업했기 때문에 간단한 프로젝트여도 설계와 유지 보수에 더더욱 초점을 두고 공부해요.
* 트러블 슈팅 과정에서 해당 문제가 해결될 때 까지 몰두해요.
* 알고리즘과 이론 지식을 공부하는걸 즐기고 좋아해요.
* 자바스크립트와 리액트, 넥스트와 타입스크립트의 언어를 맛보고 즐기고 익힙니다.
